...
class ArticleController extends Controller
{
    ...
    //     I dati arrivano dal form all'iterno dell'oggetto Request
    //     $request->all() restituisce i dati inseriti dall'utente in un form in un array chiave valore
        
    //      Validare i dati
    //     $validator = Validator::make(
    //     $request->all(), // i dati da verificare
    //     le regole sui dati
    //     [
    ...
    //     if($validator->fails()){
    //         reindirizza alla pagina precedente ( quella di creazione dell'articolo)
    //         passando anche la lista degli errori e i vecchi input scritti dall'utente
