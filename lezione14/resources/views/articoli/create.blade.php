  ...
  @endif
    ...
    <form method="POST" action="{{route('article.store')}}" enctype="multipart/form-data">
        ...
        <select class="form-select" name="category_id">
          ...
          {{-- Questo foreach prende tutte le categorie (\App\Models\Category::all()) e le cicla
          mostrano per ogni categoria un option diversa che avrà un value diverso
          
          <option value="1">Politica</option>
          <option value="2">Sport</option>
          <option value="3">Attualità</option>
          ..... --}}
